...
import com.jpd.shop.common_files.ProductCard.ProductCardTemplate;
...
public class ProductsPanel extends javax.swing.JPanel {
    ...
    private void loadProducts(int category) {
        ...
        if (object instanceof ProductData[]) {
            ...
            ProductCard.setSelectedCardToNull();
        } else {
            return;
        }
        ...
        displayProductDetails(ProductCard.getSelectedCard().PRODUCT_DATA);
    }

    private void displayProductDetails(ProductData productData) {
        PRODUCT_IMAGE.setIcon(new ImageIcon(productData.image()));
        NAME_TEXT_FIELD.setText(productData.name());
        PRICE_NUM_FIELD.setValue(productData.price() / 100.0f);
        STOCK_NUM_FIELD.setValue(productData.stock());
        CATEGORY_BOX.setSelectedIndex(productData.category());
    }
